class RuntimeObject {
    ...
    static #EularToQ(eular: mod.Vector): [number,number,number,number] {
    ...
    constructor(Enum: mod.RuntimeSpawn_Common 
                ...
                scale: mod.Vector, 
                offset: mod.Vector) {
        this.object = mod.SpawnObject(Enum, mod.Add(center,RuntimeObject.#QRotateVector(offset,RuntimeObject.#EularToQ(rotation))), rotation, scale)
        this.Enum = Enum;
        this.id = mod.GetObjId(this.object);
        this.offset = offset;

        this.centPos = center;
        this.rotState = RuntimeObject.#EularToQ(rotation);
